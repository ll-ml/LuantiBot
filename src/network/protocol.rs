...
pub const TOSERVER_INVENTORY_ACTION: u16 = 0x31;
...
pub const INTERACT_START_DIGGING: u8 = 0;
pub const INTERACT_STOP_DIGGING: u8 = 1;
pub const INTERACT_DIGGING_COMPLETED: u8 = 2;
